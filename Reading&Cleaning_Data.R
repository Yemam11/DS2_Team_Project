...
modeling_data <- data %>%
  select(TRANSFUSION_GIVEN, TOTAL_24HR_RBC ,PREOPERATIVE_ECLS, 
         ...
         PRE_PLATELETS, PRE_INR, PRE_CREATININE, PROTAMINE_Y_1_N_0_, 
         INTRA_ALBUMIN_5_ML_, INTRA_CRYSTALLOID_ML_, INTRA_CELL_SAVER_RETURNED_ML_, 
         INTRA_CRYOPRECIPITATE, LAS_SCORE, BMI, AGE, TYPE)
         
         #IDIOPATHIC_PULMONARY_HYPERTENSION, 
         #HYPERTENSION, MASSIVE_TRANSFUSION, RENAL_FAILURE, DIABETES_INSULIN_, GENDER_MALE_, 
